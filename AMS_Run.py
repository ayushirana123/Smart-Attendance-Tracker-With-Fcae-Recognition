...
window = tk.Tk()
window.title("SATFR-Smart Attendance Tracker with Face Recognition")
...
def record_attendance(enrollment_name):
    # Assuming the current date and time are being captured properly
    current_time = datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')

    # Assuming the face recognition returns a name (replace with actual logic)
    if enrollment_name:
        # Writing attendance to CSV
        with open('attendance.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([enrollment_name, current_time])
        print(f"Attendance recorded for {enrollment_name}")
    else:
        print("No face detected, attendance not recorded.")


# Example of face recognition result (replace with actual face recognition logic)
face_recognized = "ayushi"  # or None if no face is detected

record_attendance(face_recognized)
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='vuu3rbe0fd', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/rohit/Downloads/Face-Recognition-Attendance-System-main2/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/' + DB_table_name + '.csv'
            ...
            def attf():
                subprocess.Popen(
                    r'explorer /select,"C:\Users\rohit\Downloads\Face-Recognition-Attendance-System-main2\Face-Recognition-Attendance-System-main\Attendance\Check attendance\check.csv"'
                )
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='vuu3rbe0fd', db='Face_reco_fill')
                    cursor = connection.cursor()
                    cursor.execute("SELECT * FROM Face_reco_fill;")
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/rohit/Downloads/Face-Recognition-Attendance-System-main2/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        subprocess.Popen(
            r'explorer /select,"C:\Users\rohit\Downloads\Face-Recognition-Attendance-System-main2\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'ayushi':
            if password == 'ayushi123':
                ...
                cs = "C:/Users/rohit/Downloads/Face-Recognition-Attendance-System-main2/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv"
...
message = tk.Label(window, text="Smart Attendance Tracker with Face Recognition", bg="black", fg="white", width=50,
